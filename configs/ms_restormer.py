...
train.debug = True
train.output_dir = f"./exp/ms_restormer_finetune_levelx{model.arch.num_level}_block{''.join([str(i) for i in model.arch.num_blocks])}_{model.arch.stages}stg_patch960/"
