...
def CosineAnnealingLR(cfg):
    return torch.optim.lr_scheduler.CosineAnnealingLR(optimizer, cfg.max_epoch, eta_min=1e-6)
...
if __name__ == "__main__":
    ...
    scheduler = CosineWarmup(optimizer, num_warmup_steps=num_warmup_steps, num_training_steps=num_training_steps)
